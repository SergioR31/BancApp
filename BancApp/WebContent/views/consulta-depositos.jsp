...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Depositos por Periodo</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <c:forEach items="${depositos }" var="deposito">
                                            <c:if test="${deposito.status eq 'Realizado' }">
                                                <tr>
                                                    <td>${deposito.idMovimiento}</td>
                                                    <td>${deposito.concepto }</td>
                                                    <td>$${deposito.monto }0</td>
    ...
    <input type="hidden" id="totalRetiros" value="0">
