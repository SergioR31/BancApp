...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Deposito</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <form:form action="/BancApp/depositar">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            ...
                            <input id="fechaMovimiento" class="form-control" type="datetime-local" name="fechaDeposito" step="1" min="1900-01-01" max="2018-04-01" placeholder="Fecha Deposito" required>
                        </div>
                    </div>
